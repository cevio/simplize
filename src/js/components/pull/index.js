import SCROLLER from '../../application/scroller/easy';
...
export let pull = {
    ...
    methods: {
        create(){
            this.$pull = new SCROLLER(this.$els.page, {
                scrollingX: false,
                zooming: false
            });
            setTimeout(() => {
...
//
//         // y < 0 没有惯性
//         "pull:nodeceleration": function(){
//             if ( this._y < this.minScrollTop ){
//                 this.move(this.minScrollTop, Math.max(maxTime * (Math.abs(this._y - this.minScrollTop)) / this.height, minTime));
//             }
//         },
//
//         "pull:back": function(top){
//             console.log(top)
//         },
//
//
...
//             this._y = this.y;
//             const minTop = this.minScrollTop = this.height - this.$els.page.offsetHeight;
//             if ( this.y > 0 ){
//                 if ( this.y >= this.refresher.height * 2 ){ this.refresh(); }
//                 else{ this.reset(); }
//             }
//             else if ( this.y < 0 ){
//                 // // 向上
...
//                 // }
//                 // // 向下
//                 // else if ( this.startY > this.currentY ){
//                 //
//                 // }
//                 let lastTop;
//                 let ins = Deceleration(this, this._y, this._positions, timeStamp, minTop, 0, (top, dtop) => {
//                     if(top === true){
//                         this._y = lastTop;
//                     }
//                     else {
